...
abstract class ConfigsRepository {
  ...
  Future<Either<Failure, UpdateResponse>> updateConfigEntity(UpdateConfigEntityRequest request);
  ...
  Future<Either<Failure, UpdateResponse>> updateConfig(UpdateConfigRequest request);
