...
class OpenAuthApi {
  ...
  $async.Future<$5.AssignUsersToGroupResponse> assignUsersToGroup($pb.ClientContext? ctx, $5.AssignUsersToGroupRequest request) {
    var emptyResponse = $5.AssignUsersToGroupResponse();
    return _client.invoke<$5.AssignUsersToGroupResponse>(ctx, 'OpenAuth', 'AssignUsersToGroup', request, emptyResponse);
  }
  $async.Future<$5.RemoveUsersFromGroupResponse> removeUsersFromGroup($pb.ClientContext? ctx, $5.RemoveUsersFromGroupRequest request) {
    var emptyResponse = $5.RemoveUsersFromGroupResponse();
    return _client.invoke<$5.RemoveUsersFromGroupResponse>(ctx, 'OpenAuth', 'RemoveUsersFromGroup', request, emptyResponse);
  }
  ...
  $async.Future<$6.AssignPermissionsToGroupResponse> assignPermissionsToGroup($pb.ClientContext? ctx, $6.AssignPermissionsToGroupRequest request) {
    var emptyResponse = $6.AssignPermissionsToGroupResponse();
    return _client.invoke<$6.AssignPermissionsToGroupResponse>(ctx, 'OpenAuth', 'AssignPermissionsToGroup', request, emptyResponse);
  }
  $async.Future<$6.RemovePermissionsFromGroupResponse> removePermissionsFromGroup($pb.ClientContext? ctx, $6.RemovePermissionsFromGroupRequest request) {
    var emptyResponse = $6.RemovePermissionsFromGroupResponse();
    return _client.invoke<$6.RemovePermissionsFromGroupResponse>(ctx, 'OpenAuth', 'RemovePermissionsFromGroup', request, emptyResponse);
  }
  ...
  $async.Future<$6.AssignPermissionsToUserResponse> assignPermissionsToUser($pb.ClientContext? ctx, $6.AssignPermissionsToUserRequest request) {
    var emptyResponse = $6.AssignPermissionsToUserResponse();
    return _client.invoke<$6.AssignPermissionsToUserResponse>(ctx, 'OpenAuth', 'AssignPermissionsToUser', request, emptyResponse);
  }
  $async.Future<$6.RemovePermissionsFromUserResponse> removePermissionsFromUser($pb.ClientContext? ctx, $6.RemovePermissionsFromUserRequest request) {
    var emptyResponse = $6.RemovePermissionsFromUserResponse();
    return _client.invoke<$6.RemovePermissionsFromUserResponse>(ctx, 'OpenAuth', 'RemovePermissionsFromUser', request, emptyResponse);
  }
  ...
  $async.Future<$8.ConfigEntity> createConfigEntity($pb.ClientContext? ctx, $8.CreateConfigEntityRequest request) {
    var emptyResponse = $8.ConfigEntity();
    return _client.invoke<$8.ConfigEntity>(ctx, 'OpenAuth', 'CreateConfigEntity', request, emptyResponse);
  }
  $async.Future<$8.ConfigEntity> updateConfigEntity($pb.ClientContext? ctx, $8.UpdateConfigEntityRequest request) {
    var emptyResponse = $8.ConfigEntity();
    return _client.invoke<$8.ConfigEntity>(ctx, 'OpenAuth', 'UpdateConfigEntity', request, emptyResponse);
  }
  $async.Future<$8.ConfigEntity> getConfigEntity($pb.ClientContext? ctx, $8.GetConfigEntityRequest request) {
    var emptyResponse = $8.ConfigEntity();
    return _client.invoke<$8.ConfigEntity>(ctx, 'OpenAuth', 'GetConfigEntity', request, emptyResponse);
  }
  $async.Future<$8.ListConfigEntitiesResponse> listConfigEntities($pb.ClientContext? ctx, $8.ListConfigEntitiesRequest request) {
    var emptyResponse = $8.ListConfigEntitiesResponse();
    return _client.invoke<$8.ListConfigEntitiesResponse>(ctx, 'OpenAuth', 'ListConfigEntities', request, emptyResponse);
  }
  $async.Future<$8.DeleteResponse> deleteConfigEntity($pb.ClientContext? ctx, $8.DeleteConfigEntityRequest request) {
    var emptyResponse = $8.DeleteResponse();
    return _client.invoke<$8.DeleteResponse>(ctx, 'OpenAuth', 'DeleteConfigEntity', request, emptyResponse);
  }
  $async.Future<$8.Config> createConfig($pb.ClientContext? ctx, $8.CreateConfigRequest request) {
    var emptyResponse = $8.Config();
    return _client.invoke<$8.Config>(ctx, 'OpenAuth', 'CreateConfig', request, emptyResponse);
  }
  $async.Future<$8.Config> getConfig($pb.ClientContext? ctx, $8.GetConfigRequest request) {
    var emptyResponse = $8.Config();
    return _client.invoke<$8.Config>(ctx, 'OpenAuth', 'GetConfig', request, emptyResponse);
  }
  $async.Future<$8.Config> getConfigByKey($pb.ClientContext? ctx, $8.GetConfigByKeyRequest request) {
    var emptyResponse = $8.Config();
    return _client.invoke<$8.Config>(ctx, 'OpenAuth', 'GetConfigByKey', request, emptyResponse);
  }
  $async.Future<$8.GetConfigsByKeysResponse> getConfigsByKeys($pb.ClientContext? ctx, $8.GetConfigsByKeysRequest request) {
    var emptyResponse = $8.GetConfigsByKeysResponse();
    return _client.invoke<$8.GetConfigsByKeysResponse>(ctx, 'OpenAuth', 'GetConfigsByKeys', request, emptyResponse);
  }
  $async.Future<$8.ListConfigsResponse> listConfigs($pb.ClientContext? ctx, $8.ListConfigsRequest request) {
    var emptyResponse = $8.ListConfigsResponse();
    return _client.invoke<$8.ListConfigsResponse>(ctx, 'OpenAuth', 'ListConfigs', request, emptyResponse);
  }
  $async.Future<$8.Config> updateConfig($pb.ClientContext? ctx, $8.UpdateConfigRequest request) {
    var emptyResponse = $8.Config();
    return _client.invoke<$8.Config>(ctx, 'OpenAuth', 'UpdateConfig', request, emptyResponse);
  }
  $async.Future<$8.DeleteResponse> deleteConfig($pb.ClientContext? ctx, $8.DeleteConfigRequest request) {
    var emptyResponse = $8.DeleteResponse();
    return _client.invoke<$8.DeleteResponse>(ctx, 'OpenAuth', 'DeleteConfig', request, emptyResponse);
  }
}
