...
// Validate checks the field values on SignInWithLoginTokenRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *SignInWithLoginTokenRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SignInWithLoginTokenRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SignInWithLoginTokenRequestMultiError, or nil if none found.
func (m *SignInWithLoginTokenRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *SignInWithLoginTokenRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if utf8.RuneCountInString(m.GetLoginToken()) < 1 {
		err := SignInWithLoginTokenRequestValidationError{
			field:  "LoginToken",
	...
	if m.Metadata != nil {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, SignInWithLoginTokenRequestValidationError{
						field:  "Metadata",
						reason: "embedded message failed validation",
						cause:  err,
					})
			...
			if err := v.Validate(); err != nil {
				return SignInWithLoginTokenRequestValidationError{
					field:  "Metadata",
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return SignInWithLoginTokenRequestMultiError(errors)
	}

	return nil
}

// SignInWithLoginTokenRequestMultiError is an error wrapping multiple
// validation errors returned by SignInWithLoginTokenRequest.ValidateAll() if
// the designated constraints aren't met.
type SignInWithLoginTokenRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SignInWithLoginTokenRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SignInWithLoginTokenRequestMultiError) AllErrors() []error { return m }

// SignInWithLoginTokenRequestValidationError is the validation error returned
// by SignInWithLoginTokenRequest.Validate if the designated constraints
// aren't met.
type SignInWithLoginTokenRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SignInWithLoginTokenRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SignInWithLoginTokenRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SignInWithLoginTokenRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SignInWithLoginTokenRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SignInWithLoginTokenRequestValidationError) ErrorName() string {
	return "SignInWithLoginTokenRequestValidationError"
}

// Error satisfies the builtin error interface
func (e SignInWithLoginTokenRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSignInWithLoginTokenRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SignInWithLoginTokenRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SignInWithLoginTokenRequestValidationError{}
