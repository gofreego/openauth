...
const file_proto_openauth_v1_groups_proto_rawDesc = "" +
	"\n" +
	"\x1eproto/openauth/v1/groups.proto\x12\x02v1\x1a\x17validate/validate.proto\"\xff\x01\n" +
	"\x05Group\x12\x0e\n" +
	...
	"\vdescription\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xe8\aH\x00R\vdescription\x88\x01\x01\x12\x1d\n" +
	"\n" +
	...
	"\x02id\x18\x01 \x01(\x03B\a\xfaB\x04\"\x02 \x00R\x02id\"3\n" +
	"\x10GetGroupResponse\x12\x1f\n" +
	"\x05group\x18\x01 \x01(\v2\t.v1.GroupR\x05group\"\xdf\x01\n" +
	"\x12UpdateGroupRequest\x12\x17\n" +
	"\x02id\x18\x01 \x01(\x03B\a\xfaB\x04\"\x02 \x00R\x02id\x12\"\n" +
	"\x04name\x18\x04 \x01(\tB\t\xfaB\x06r\x04\x10\x03\x18dH\x00R\x04name\x88\x01\x01\x121\n" +
	"\fdisplay_name\x18\x05 \x01(\tB\t\xfaB\x06r\x04\x10\x03\x18dH\x01R\vdisplayName\x88\x01\x01\x12/\n" +
	"\vdescription\x18\x06 \x01(\tB\b\xfaB\x05r\x03\x18\xe8\aH\x02R\vdescription\x88\x01\x01B\a\n" +
	"\x05_nameB\x0f\n" +
	"\r_display_nameB\x0e\n" +
	"\f_description\"P\n" +
	...
	"\x06groups\x18\x01 \x03(\v2\t.v1.GroupR\x06groups\"\xa8\x01\n" +
	"\x19AssignUsersToGroupRequest\x12+\n" +
	"\buser_ids\x18\x01 \x03(\x03B\x10\xfaB\r\x92\x01\n" +
	"\b\x01\x10d\"\x04\"\x02 \x00R\auserIds\x12\"\n" +
	"\bgroup_id\x18\x02 \x01(\x03B\a\xfaB\x04\"\x02 \x00R\agroupId\x12+\n" +
	"\n" +
	"expires_at\x18\x03 \x01(\x03B\a\xfaB\x04\"\x02(\x00H\x00R\texpiresAt\x88\x01\x01B\r\n" +
	"\v_expires_at\"P\n" +
	"\x1aAssignUsersToGroupResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\"n\n" +
	"\x1bRemoveUsersFromGroupRequest\x12+\n" +
	"\buser_ids\x18\x01 \x03(\x03B\x10\xfaB\r\x92\x01\n" +
	"\b\x01\x10d\"\x04\"\x02 \x00R\auserIds\x12\"\n" +
	"\bgroup_id\x18\x02 \x01(\x03B\a\xfaB\x04\"\x02 \x00R\agroupId\"R\n" +
	"\x1cRemoveUsersFromGroupResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\"i\n" +
	"\x15ListGroupUsersRequest\x12\"\n" +
	"\bgroup_id\x18\x01 \x01(\x03B\a\xfaB\x04\"\x02 \x00R\agroupId\x12\x14\n" +
