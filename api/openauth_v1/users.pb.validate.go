...
// Validate checks the field values on MarkProfileURLUpdatedRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *MarkProfileURLUpdatedRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on MarkProfileURLUpdatedRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// MarkProfileURLUpdatedRequestMultiError, or nil if none found.
func (m *MarkProfileURLUpdatedRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *MarkProfileURLUpdatedRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if l := utf8.RuneCountInString(m.GetProfileUuid()); l < 1 || l > 36 {
		err := MarkProfileURLUpdatedRequestValidationError{
			field:  "ProfileUuid",
			reason: "value length must be between 1 and 36 runes, inclusive",
		}
		if !all {
	...
	if len(errors) > 0 {
		return MarkProfileURLUpdatedRequestMultiError(errors)
	}

	return nil
}

// MarkProfileURLUpdatedRequestMultiError is an error wrapping multiple
// validation errors returned by MarkProfileURLUpdatedRequest.ValidateAll() if
// the designated constraints aren't met.
type MarkProfileURLUpdatedRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m MarkProfileURLUpdatedRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m MarkProfileURLUpdatedRequestMultiError) AllErrors() []error { return m }

// MarkProfileURLUpdatedRequestValidationError is the validation error returned
// by MarkProfileURLUpdatedRequest.Validate if the designated constraints
// aren't met.
type MarkProfileURLUpdatedRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e MarkProfileURLUpdatedRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e MarkProfileURLUpdatedRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e MarkProfileURLUpdatedRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e MarkProfileURLUpdatedRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e MarkProfileURLUpdatedRequestValidationError) ErrorName() string {
	return "MarkProfileURLUpdatedRequestValidationError"
}

// Error satisfies the builtin error interface
func (e MarkProfileURLUpdatedRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sMarkProfileURLUpdatedRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = MarkProfileURLUpdatedRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = MarkProfileURLUpdatedRequestValidationError{}
